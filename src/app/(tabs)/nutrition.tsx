...
const phaseNutrition: Record<CyclePhase, PhaseNutritionData> = {
  ...
  ovulatory: {
    focus: 'Light & Vibrant',
    description: 'Peak energy time! Support your body with fiber-rich foods that help metabolize the estrogen surge.',
    days: 'Days 14-17',
    foods: [
      { name: 'Berries', benefit: 'Antioxidants and fiber' },
      { name: 'Wild Fish', benefit: 'Salmon, mackerel, sardines' },
      { name: 'Walnuts', benefit: 'Omega-3s and vitamin E' },
      { name: 'Bell Peppers', benefit: 'Vitamin C and antioxidants' },
      { name: 'Dark Leafy Greens', benefit: 'Fiber and nutrients' },
      { name: 'Chia Seeds', benefit: 'Omega-3s and fiber' },
      { name: 'Sunflower Seeds', benefit: 'Seed cycling - switch now' },
      { name: 'Sesame Seeds', benefit: 'Seed cycling - add these' },
      { name: 'Legumes', benefit: 'Fiber and protein' },
      { name: 'Colorful Vegetables', benefit: 'Rainbow variety' },
    ],
    avoid: ['Heavy carbs', 'Fried foods', 'Excess dairy'],
    tips: ['Focus on raw and lightly cooked foods', 'Great time for smoothies', 'Stay well hydrated'],
    fertilityInfo: {
      title: 'Fertility Awareness',
      description: 'Ovulation is your most fertile time. An egg is released and can be fertilized for 12-24 hours.',
      keyPoints: [
