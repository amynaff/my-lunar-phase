        ...
        <div className="font-quicksand text-text-secondary space-y-8 text-[15px] leading-relaxed">
          ...
          <section>
            ...
            <ul className="space-y-2 ml-4">
              <li className="flex gap-2"><span className="text-accent-purple flex-shrink-0">-</span><span><strong>Email &amp; password</strong> &mdash; So you can sign in to your account. Passwords are managed by Supabase Auth and we cannot see them.</span></li>
          ...
          <section>
            ...
            <ul className="space-y-2 ml-4 mt-3">
              ...
              <li className="flex gap-2"><span className="text-accent-purple flex-shrink-0">-</span><span><strong>Passwords are protected</strong> &mdash; Authentication is handled by Supabase Auth. We cannot view or recover your password.</span></li>
